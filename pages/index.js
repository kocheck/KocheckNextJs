      ...
      <div>
        <div className={css.hero}>
          ...
          <h2 className={css.title}>
            <a href="/now">Currently</a> the senior product designer, at
            Roadtrippers 🗺. Freelance designer and coffee nerd. Feel free to
            reach out! Lets talk about pixels, maps, or coffee ✌️
          </h2>
